...
if (isset($_REQUEST['updateconf']) && isset($_REQUEST['nonce']) && wp_verify_nonce($_REQUEST['nonce'], 'whmcs-pi_update-api-options')) {
    ...
    update_option('whmcs-pi_clientareaurl', $_REQUEST['whmcs-pi-client-url']);
 ...
 */
    ...
    .whmcs-pi .options_grp .config_form {
        min-width: 50px;
    }

    .whmcs-pi .options_grp .config_form input {
        width: 400px;
    }

    .whmcs-pi .options_grp .config_form label {
        margin-bottom: 1em;
        display: block;
    }

    .whmcs-pi .options_grp .config_form span {
    ...
    #whmcs-pi-close:hover {
        background-color: #b0d2a8;
    }
</style>
        ...
        <div class="options_grp flex_base">
            <div class="config_form">
                <form method="post">
                    ...
                    <label for="whmcs-pi-client-url">
                        <span><? _e("WHMCS client area URL address :", "whmcs-pi"); ?></span>
                        <input type="text" name="whmcs-pi-client-url" value="<?= get_option('whmcs-pi_clientareaurl') ?>">
                    </label>
